...
const Footer = () => {
    return (
        <>
            <footer className="bg-gc-900 pt-12 pb-8 px-10 tracking-wide mt-14">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        <div className="lg:flex items-start flex-col">
                            ...
                            <p className='text-white lg:text-base text-sm mt-5'>
                                Lorem ipsum dolor sit amet consectetur adipisicing elit. Repudiandae iste quam animi quasi consectetur deleniti tempore voluptatum perferendis illo. Minus dolore at ab eum atque debitis, dolores quibusdam sapiente totam.
                            </p>
                        </div>
                            ...
                            <ul className="flex gap-6">
                                ...
                                <li>
                                    <a href='#'>
                                        ...
                                        <LuLinkedin className='text-blue-400 size-10' />
                                    </a>
                                </li>
                                <li>
                                    <a href='#'>
